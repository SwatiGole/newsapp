...
/* @Entity: creates table of the class(class-News).
...
public class News 
{
	...
	/* @Id: use to mark column as id(Primary Key).
	   ...
	   @GeneratedValue: Hibernate will automatically generate values for that using an internal sequence. Therefore, we don't have to set it 
	                    manually.  */
	...
	/* @Size: to restrict the filed length to a specified value. */
	@Size(max = 500)
